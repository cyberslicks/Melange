...
var d= a + " " + b + " " + c ;
document.getElementById("txt").style.border=d;
...
document.getElementById("txt").style.background=c;
document.getElementById("txt").style.textAlign=d;
document.getElementById("txt").style.color=f;
