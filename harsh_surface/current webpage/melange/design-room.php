...
<header id="main-header">
		...
		?>
	               ...
	               &nbsp; &nbsp;
               <img src="./images/cogs.png" id="cogs"> &nbsp;&nbsp;<span style="color:#27c6f4;font-family:'Arial Narrow';">Alpha</span>
               </div>
          </div>
     </header>
...
<div class="button-set">
	<div class='button' id="button">But</div>
	<div class='button' id="textfield">tfld</div>
</div>	
<div class="button-set">
	<div class='button' id="radio">radio</div>
	<div class='button' id="password">pwd</div>
</div>	
<div class="button-set">
	<div class='button' id="checkbox">chbx</div>
	<div class='button' id="form">From</div>
</div>	
<div class="button-set">
	<div class='button' id="dropdown">dd</div>
	<div class='button' id="form">From</div>
</div>	
...
<div id="Buttonproperties"> 
			...
			<div Class="Property" id="ButtonSize">
				Size :
			</div>
			<div class="PropertyContent" id="ButtonSizeContent">
			<center>
				<input type="button" class="propbutton" id="ButtonHeightInc" value="Height++">
				<input type="button" class="propbutton" id="ButtonWidthInc" value="Width++"><br>
				<input type="button" class="propbutton" id="ButtonHeightDec" value="Height--">
				<input type="button" class="propbutton" id="ButtonWidthDec" value="Width--">
			</center>
			</div>
			
			<div Class="Property" id="ButtonSpace">
				Spacing :
			</div>
			<div class="PropertyContent" id="ButtonSpaceContent">
				<center>
				<input type="button" class="propbutton" id="ButtonHSpaceInc" value="H-Space ++">
				<input type="button" class="propbutton" id="ButtonVSpaceInc" value="V-Space ++"><br>
				<input type="button" class="propbutton" id="ButtonHSpaceDec" value="H-Space --">
				<input type="button" class="propbutton" id="ButtonVSpaceDec" value="V-Space --">
			</div>
			
			
			
			<div Class="Property" id="ButtonBorder">
				Border :
			</div>
			<div class="PropertyContent" id="ButtonBorderContent">
				
				<input type="button" id="border-color" style="background-color:#000000; border:thin solid white;height:50px;width:50px;margin-left:5px;">
				&nbsp; &nbsp;
				
				<select id="Button-border-style">
				...
				<br><br>
				<input type="range" id="Button-border-width" min="1" max="20" width="100px" value="0">
				<br>
				
				
				<input type="button" class="propbutton" id="Button-border" value="set">
