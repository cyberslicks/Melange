...
<div class="header">
	...
	Blog </h1>
		...
		//echo "<a href=\"".$oAuth->getLogoutUrl()."\">log-out</a>";
			...
			echo " <a href=\"#loginbox\"><input type=\"button\" class=\"b-awesome\" value=\"Log In\"/></span></a>";
...
<div class="clear"></div>		
		...
		<section class="menuslide" style="width: 1263px; ">
			...
			<article class="container_12">
				...
				<a  class="grid_4" href="about.php"><span class="grid3logo" id="abouticon"></span>about<span>About Melange</span></a>
				<a  class="grid_4" href="feedback.php" ><span class="grid3logo" id="contacticon"></span>Contact<span>Got Question?? contact us</span></a>
	...
	<div class="page secondary"><!--division responsible for mansory css-->
	   ...
	   <?php
			...
			echo "<span style=\"color:#f58930; font-weight:bold;\">Welcome "  .$_SESSION['user_name'] . "</span>";
			echo "</br></br>";
			echo "<p style=\"color:#4ac8f5; font-weight:bold;\"> You can now  access our Design-Room page for Alpha preview.</p>";
			echo "</br>";
