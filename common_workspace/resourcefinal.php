...
<div class="header">
	...
	<h1 id="title"><center> Resources</h1></center>
...
<div id="poldiv">
	<ul class="polaroids">
		<li>
			<a href="button-gen.php" title="Button CSS Generator">
				<img src="./Polaroid_files/image-01.jpg" alt="Button Generator">
			</a>
		</li>
		<li>
			<a href="beautify.php" title="Html Formatter">
				<img src="./Polaroid_files/image-02.jpg" alt="HTML Formatter">
			</a>
		</li>
		<li>
			<a href="websearch.php" title="Search on web">
				<img src="./Polaroid_files/image-03.jpg" alt="Search on Web">
			</a>
		</li>
